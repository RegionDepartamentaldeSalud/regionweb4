/*
  # Vinculación automática de documentos administrativos

  1. Cambios
    - Añade función para extraer número de oficio del título
    - Añade trigger para vincular documentos administrativos
